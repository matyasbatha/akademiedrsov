      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full bg-gold text-navy py-3 rounded-xl font-bold hover:bg-gold-dark transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isPending ? (
              <>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Máte již účet?{" "}
          <Link href="/prihlaseni" className="text-gold font-medium hover:text-gold-dark">
            Přihlásit se
          </Link>
        </p>
      </div>
